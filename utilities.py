...
- translate_datetime - Convert filenames. PLI1_20240316_122600 -> ('2024-Mar-16', '12:26:00')
...
def get_raw_audio(raw_audio, raw_data_root, mic2_name, mic2_delim):
    """
    ...
    def get_audio(sample):
        ...
        return os.path.join(raw_data_root, year, mic2_name, loc, audio_key)
